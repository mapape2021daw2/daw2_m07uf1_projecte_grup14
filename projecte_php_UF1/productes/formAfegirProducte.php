...
<html>
    ...
    <body>
        ...
        <div>
            ...
            <form action="../classes/productes.php" method="POST">
                <label>Codi:</label>
                <input name="codi" type="text"><br>
                <label>Secció:</label>
                <input name="seccio" type="text"><br>
                <label>Nom:</label>
                <input name="nom" type="text"><br>
                <label>Preu:</label>
                <input name="preu" type="text"><br>
                <label>Imatge</label>
                <input name="imatge" type="text"><br>
